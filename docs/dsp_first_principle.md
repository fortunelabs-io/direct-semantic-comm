...
A cross-check against a commercial single-rail meter, if one can be borrowed, is worth taking. It is not a dependency and it does not enter the method; it converts the Stage 0 claim from agreement with a resistor into agreement with an instrument the field already accepts, on the one case both can measure.
